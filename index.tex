...
\hypersetup{
  pdftitle={Aquarium sop},
  pdfauthor={Sebbi Kankondi},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/plant_room/filter_tanks2.jpg}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/plant_room/ft_lid72.jpg}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/plant_room/filter_media2.jpg}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/plant_room/ft_lid_strainer2.jpg}
...
\includegraphics{images/plant_room/ft_internal2.jpg}

}

}

\subcaption{\label{fig-ft-outlet-pipe}Central outlet pipe}
\end{minipage}%
%
\begin{minipage}[t]{0.33\linewidth}
...
\includegraphics{images/plant_room/ft_rosette2.jpg}

}

}

\subcaption{\label{fig-rosette-filter}Rosette filter}
\end{minipage}%
%
\begin{minipage}[t]{0.33\linewidth}
...
\includegraphics{images/plant_room/rosette_support2.jpg}

}

}

\subcaption{\label{fig-rosette-support}Rosette support}
\end{minipage}%
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/plant_room/fm_fp_strainer.jpg}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/plant_room/prosonic1.jpg}
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{images/display/urchin_display2.jpg}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{images/quar_tanks/elasmo_chart.png}
...
{\centering \includegraphics[width=1\textwidth,height=\textheight]{images/quar_tanks/ray_chart.png}
...
\leavevmode\vadjust pre{\hypertarget{ref-arthur2008}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-jones2014}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-leary2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-oie2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-vaughan2019}{}}%
